...
def _hparams(algorithm, dataset, random_seed):
    ...
    elif algorithm == 'xdomain_mix' or algorithm == 'xdomain_mix_sam':
        _hparam('warmup_step', 3000, lambda r: 3000) 
        _hparam('threshold', 0.9, lambda r: 0.9)
        _hparam('threshold_lower_bound', 0.5, lambda r: 0.5)
        _hparam('value_to_change', 0.1, lambda r: 0.1)
        _hparam('probability_to_discard', 0.2, lambda r: 0.2)
        _hparam('step_to_change', 100, lambda r: 100)
        

    elif algorithm == "LISA":
        _hparam('mix_alpha', 2, lambda r: 2)
        _hparam('cutmix',True, lambda r: True)
